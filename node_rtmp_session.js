	...
	rtmpInvokeHandler() {
		...
		switch (invokeMessage.cmd) {
			...
			case 'receiveVideo':
				...
				break
			case 'packet':
				context.nodeEvent.emit('packet', invokeMessage.transId, this.playStreamPath, { 'messageType': invokeMessage.messageTypeId, 'message': invokeMessage.messageId, 'data': invokeMessage.data })
				break
		}
	}
